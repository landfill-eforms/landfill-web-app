 ...
 */
@MappedSuperclass
public abstract class ServiceEmissionExceedanceRepairData implements Comparable<ServiceEmissionExceedanceRepairData> {
	...
	@Override
	public int compareTo(ServiceEmissionExceedanceRepairData o) {
